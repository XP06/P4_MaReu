package fr.xp06.mareu.ui.meeting_list;
...
import fr.xp06.mareu.utils.DeleteViewAction;
...
import static fr.xp06.mareu.utils.Utils.minutes;
import static fr.xp06.mareu.utils.Utils.month;
import static fr.xp06.mareu.utils.Utils.year;
...
public class MeetingsListTest {
    ...
    public void checkIfAddingMeetingIsWorking() {
        ...
        onView(withId(R.id.meetings_recylerview)).check(withItemCount(ITEMS_COUNT));
        ...
        onView(withId(R.id.meetings_recylerview)).check(withItemCount(ITEMS_COUNT + 1));
    }
    ...
    public void checkIfFormValidationIsWorking_NewMeetingView() {
        onView(withId(R.id.fab_add_meeting)).perform(click());
        onView(withId(R.id.form_btn)).perform(click());
        onView(withId(R.id.subject)).check(matches(hasTextInputLayoutHintText("Ce champ est requis!")));
    }
    ...
    public void checkIfDeleteMeetingIsWorking() {
        ...
        onView(withId(R.id.meetings_recylerview))
    ...
    public void checkIfFiltersAreWorking() {
        ...
        onView(withId(R.id.meetings_recylerview)).check(withItemCount(ITEMS_COUNT + 2));
